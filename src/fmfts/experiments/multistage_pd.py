...
def main():
    ...
    for s in range(1, n_stages + 1):
        ...
        print(f"[multistage] Stage {s}/{n_stages} | teacher={teacher_path} | iters={stage_iters[s-1]}")
