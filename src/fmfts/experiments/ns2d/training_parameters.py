...
# from fmfts.utils.models.cfm_velocity_pd import (
#     uniform_delta_sampler, 
...
params = {
    ...
    #     "initial_teacher": "state_velocity.pt",
    # },
